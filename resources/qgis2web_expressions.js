...
function exp_label_BANGUNANNOMENKLATUR_11_eval_expression(context) {
    // NAME + ' ' + URUTAN + ' ' + URUTAN_KAN

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('NAME')  + ' ') + feature.get('URUTAN') ) + ' ') + feature.get('URUTAN_KAN') );
    } else {
        return ((((feature.get('NAME')  + ' ') + feature.get('URUTAN') ) + ' ') + feature.get('URUTAN_KAN') );
    }
}