...
case 'Rusak Berat':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(253,159,56,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3.8}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
case 'Rusak Ringan':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(208,212,118,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3.8}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
